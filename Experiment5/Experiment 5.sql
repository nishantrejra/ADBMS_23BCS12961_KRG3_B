...
SELECT 
ID,COUNT(*) AS total_quantity_sold, 
...
customer_name VARCHAR(100), email 
...
VALUES 
('Shivam', 'shivam@example.com', '1234567891', '1234-5678-9012-3456', 500), 
('shivam', 'shivam@example.com', '1234567891', '1234-5678-9012-3456', 1000), 
...
from customer_data group by 
customer_name; select * from 
restricted_sales_data; 
